...
public class LoginScreen extends Screen {
	...
	public void render(Bitmap bitmap) {
		...
		bitmap.drawText("Username:", engine.getScaledWidth() / 2 - 100, engine.getHeight() / 2 - 35, false);
		bitmap.drawText("Password:", engine.getScaledWidth() / 2 - 100, engine.getHeight() / 2 - 4, false);
	}
